	...
	<div class="wrap theme-info-wrap">
		...
		<div class="important-links clearfix">
			<p><strong><?php esc_html_e( 'Theme Links', 'dynamic-news-lite' ); ?>:</strong>
				<a href="<?php echo esc_url( 'http://themezee.com/themes/dynamicnews/?utm_source=theme-info&utm_medium=textlink&utm_campaign=dynamic-news&utm_content=theme-page' ); ?>" target="_blank"><?php esc_html_e( 'Theme Page', 'dynamic-news-lite' ); ?></a>
				...
				<a href="<?php echo esc_url( 'http://themezee.com/docs/dynamicnews-documentation/?utm_source=theme-info&utm_medium=textlink&utm_campaign=dynamic-news&utm_content=documentation' ); ?>" target="_blank"><?php esc_html_e( 'Theme Documentation', 'dynamic-news-lite' ); ?></a>
			...
			<div class="columns-wrapper clearfix">
				...
				<div class="column column-half clearfix">
					...
					<div class="section">
						...
						<p>
							<a href="<?php echo esc_url( 'http://themezee.com/docs/dynamicnews-documentation/?utm_source=theme-info&utm_medium=button&utm_campaign=dynamic-news&utm_content=documentation' ); ?>" target="_blank" class="button button-secondary">
					...
					<div class="section">
						...
						<p>
							<a href="<?php echo esc_url( 'http://themezee.com/themes/dynamicnews/?utm_source=theme-info&utm_medium=button&utm_campaign=dynamic-news&utm_content=pro-version' ); ?>" target="_blank" class="button button-secondary">
		...
		<div id="theme-author">
			...
			<p><?php printf( esc_html__( '%1$s is proudly brought to you by %2$s. If you like this theme, %3$s :)', 'dynamic-news-lite' ), 
				$theme->get( 'Name' ),
				'<a target="_blank" href="http://themezee.com/?utm_source=theme-info&utm_medium=footer&utm_campaign=dynamic-news" title="ThemeZee">ThemeZee</a>',
