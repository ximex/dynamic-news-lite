	...
	<div class="wrap theme-info-wrap">
		...
		<div class="important-links clearfix">
			<p><strong><?php esc_html_e( 'Important Links:', 'dynamic-news-lite' ); ?></strong>
				...
				<a href="http://themezee.com/docs/dynamicnews-documentation/" target="_blank"><?php esc_html_e( 'Theme Documentation', 'dynamic-news-lite' ); ?></a>
				<a href="http://wordpress.org/support/view/theme-reviews/dynamic-news-lite?filter=5" target="_blank"><?php esc_html_e( 'Rate this theme', 'dynamic-news-lite' ); ?></a>
			</p>
		</div>
		<hr>
			...
			<div class="columns-wrapper clearfix">
				...
				<div class="column column-half clearfix">
					...
					<div class="section">
						...
						<p class="about">
							<?php esc_html_e( 'You need more features? Purchase the Pro Version to get additional features and advanced customization options.', 'dynamic-news-lite' ); ?>
						</p>
						<p>
