...
function dynamicnews_customize_controls_js() {
	...
	wp_localize_script( 'dynamicnewslite-customizer-controls', 'dynamicnews_theme_links', array(
		...
		'themeURL'	=> esc_url( 'http://themezee.com/themes/dynamicnews/?utm_source=customizer&utm_medium=textlink&utm_campaign=dynamic-news&utm_content=theme-page' ),
		'themeLabel'	=> esc_html__( 'Theme Page', 'dynamic-news-lite' ),
		'docuURL'	=> esc_url( 'http://themezee.com/docs/dynamicnews-documentation/?utm_source=customizer&utm_medium=textlink&utm_campaign=dynamic-news&utm_content=documentation' ),
